...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./Users/attila/Herd/classen/public/storage' => 'string',
...
'filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.links./Users/attila/Herd/classen/public/storage','googletagmanager.id','googletagmanager.enabled',
...
'components.layouts.navigation.navbar','components.modal','components.nav.breadcrumb','components.nav.breadcrumb-home-end','components.partials.blog',
'components.partials.collections-grid','components.partials.door-categories','components.partials.elonyok','components.partials.expert-help','components.partials.expert-help-index',
'components.partials.hero-banner','components.partials.hero-banner-2','components.partials.hero-banner-3','components.partials.prd-carousel','components.primary-button',
'components.responsive-nav-link','components.row','components.secondary-button','components.svg.application-logo','components.svg.boiler',
'components.svg.boiler-search','components.svg.edit','components.svg.eye','components.svg.heart','components.svg.hero-btn-arrow',
'components.svg.hero-nav-next','components.svg.hero-nav-prev','components.svg.multiply-icon','components.svg.plus-icon','components.svg.search',
'components.svg.trash','components.text-input','cookie-consent::button','cookie-consent::cookies','doors.index',
'doors.show','example','favorites.index','google.enterior','google.index',
'google.modern','google.woodenstyle','index','jogi.adatvedelem','jogi.aszf',
'kapcsolat.index','kiemelt-termekeink','kilincsek.index','layouts.guest','letoltesek.index',
'livewire.app','livewire.collection-item','livewire.door-options','livewire.filter-for-category-sidebar','livewire.filter-for-product-sidebar',
'livewire.pop-up-modal','livewire.remove-quotation-item','livewire.request-quotation-button','livewire.search-box','livewire.update-quotation-item',
'livewire::bootstrap','livewire::original-tailwind','livewire::simple-bootstrap','livewire::simple-tailwind','livewire::tailwind',
'mail.form.contact-form','mail.quotation.inner-sended','mail.quotation.sended','profile.edit','profile.partials.delete-user-form',
'profile.partials.update-password-form','profile.partials.update-profile-information-form','quotation.index','quotation.success','rolunk.index',
'szolgaltatasaink.index','toaster::hub','vendor.cookie-consent.button','vendor.cookie-consent.cookies','vendor.livewire.bootstrap',
'vendor.livewire.original-tailwind','vendor.livewire.simple-bootstrap','vendor.livewire.simple-tailwind','vendor.livewire.tailwind','vendor.toaster.hub',
'cookie-consent::button','cookie-consent::cookies','cookie-consent::info','filament-actions::badge-action','filament-actions::badge-group',
...
'filament::components.tabs.index','filament::components.tabs.item','googletagmanager::body','googletagmanager::head','googletagmanager::script',
...
'pagination::simple-bootstrap-5','pagination::simple-default','pagination::simple-tailwind','pagination::tailwind','seo::tags.tag',
'sitemap::image','sitemap::news','sitemap::sitemap','sitemap::sitemapIndex.index','sitemap::sitemapIndex.sitemap',
'sitemap::url','sitemap::video','telescope::layout','toaster::hub',);
