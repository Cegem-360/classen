...
'debugbar.debug_backtrace_limit','essentials.NunoMaduro\\Essentials\\Configurables\\Unguard','seo.model','seo.site_name','seo.sitemap',
...
'logging.channels.null.handler','logging.channels.emergency.path','logging.channels.deprecations.driver','logging.channels.deprecations.handler','filesystems.default',
...
'filesystems.disks.s3.report','filesystems.links./Users/szabozoltan/Herd/classen/public/storage','blade-heroicons.prefix','blade-heroicons.fallback','blade-heroicons.class',
...
'filament.cache_path','filament.livewire_loading_delay','filament.system_route_prefix','lang-generator.file_type','lang-generator.file_name',
'lang-generator.short_keys','lang-generator.languages','sanctum.stateful','sanctum.guard','sanctum.expiration',
...
'excel.temporary_files.remote_disk','excel.temporary_files.remote_prefix','excel.temporary_files.force_resync_remote','helpers.laravel.guess_factory_names_with_domain_namespace','helpers.laravel.guess_factory_names_with_support_namespace',
...
'filament.admin.resources.website-options.index','filament.admin.resources.website-options.create','filament.admin.resources.website-options.view','filament.admin.resources.website-options.edit','sanctum.csrf-cookie','telescope','livewire.update','livewire.upload-file','livewire.preview-file','cookieconsent.script',
...
'quotation.remove','quotation.updateItem','seo.raktari-ajtok-megbizhatosag-tartossag','seo.raktari-ajtok-tokeletes-valasztas-otthonaba-es-munkahelyere','seo.belteri-ajtok',
'seo.cpl','quote','updateWebsiteDatabase.trigger',
'aszf','adatvedelem',
'featured-sales-areas.index','featured-sales-areas.show','storage.local',);
...
'livewire.featured-sales-areas-show','livewire.filter-for-category-sidebar','livewire.filter-for-product-sidebar','livewire.pop-up-modal','livewire.remove-quotation-item',
'livewire.request-quotation-button','livewire.search-box','livewire.update-quotation-item','livewire::bootstrap','livewire::original-tailwind',
'livewire::simple-bootstrap','livewire::simple-tailwind','livewire::tailwind','mail.form.contact-form','mail.quotation.inner-sended',
'mail.quotation.sended','pages.featured-sales-areas.index','pages.featured-sales-areas.show','profile.edit','profile.partials.delete-user-form',
...
'honeypot::honeypotFormFields','laravel-exceptions-renderer::components.card','laravel-exceptions-renderer::components.context','laravel-exceptions-renderer::components.editor','laravel-exceptions-renderer::components.header',
