...
'filament.admin.auth.logout','filament.admin.pages.dashboard','filament.admin.resources.blogs.index','filament.admin.resources.blogs.create','filament.admin.resources.blogs.view',
'filament.admin.resources.blogs.edit','sanctum.csrf-cookie',
'telescope','livewire.update','livewire.upload-file',
'livewire.preview-file','ignition.healthCheck','ignition.executeSolution','ignition.updateConfig','cookieconsent.script',
'cookieconsent.accept.all','cookieconsent.accept.essentials','cookieconsent.accept.configuration','cookieconsent.reset',
'index','door.index','door.show','category.index','category.show','exel.proccess','rolunk','kapcsolat','mail.sendContact',
'szolgaltatasaink','blog','blog.show','favorites.index','downloads',
'kilincsek','meta','enterior','modern','woodenstyle',
'kiemelt-termekeink','quotation.index','quotation.add','quotation.store','quotation.success',
'quotation.remove','quotation.updateItem','quote',
'updateWebsiteDatabase.trigger','aszf','adatvedelem',);
...
'components.form','components.header.layout','components.icons.facebook','components.icons.instagram','components.icons.mail',
'components.icons.pin','components.icons.youtube','components.input-error','components.input-label','components.layouts.app',
'components.layouts.navigation.navbar','components.modal','components.nav.breadcrumb','components.nav.breadcrumb-home-end','components.partials.collections-grid',
'components.partials.door-categories','components.partials.elonyok','components.partials.expert-help','components.partials.expert-help-index','components.partials.hero-banner',
'components.partials.hero-banner-2','components.partials.hero-banner-3','components.partials.prd-carousel','components.primary-button','components.responsive-nav-link',
'components.row','components.secondary-button','components.svg.application-logo','components.svg.boiler','components.svg.boiler-search',
'components.svg.edit','components.svg.eye','components.svg.heart','components.svg.hero-btn-arrow','components.svg.hero-nav-next',
'components.svg.hero-nav-prev','components.svg.multiply-icon','components.svg.plus-icon','components.svg.search','components.svg.trash',
'components.text-input','cookie-consent::button','cookie-consent::cookies','doors.index','doors.show',
'example','favorites.index','google.enterior','google.index','google.modern',
'google.woodenstyle','index','jogi.adatvedelem','jogi.aszf','kapcsolat.index',
'kiemelt-termekeink','kilincsek.index','layouts.guest','letoltesek.index','livewire.app',
'livewire.collection-item','livewire.door-options','livewire.filter-for-category-sidebar','livewire.filter-for-product-sidebar','livewire.pop-up-modal',
'livewire.remove-quotation-item','livewire.request-quotation-button','livewire.search-box','livewire.update-quotation-item','livewire::bootstrap',
'livewire::original-tailwind','livewire::simple-bootstrap','livewire::simple-tailwind','livewire::tailwind','mail.form.contact-form',
'mail.quotation.inner-sended','mail.quotation.sended','profile.edit','profile.partials.delete-user-form','profile.partials.update-password-form',
'profile.partials.update-profile-information-form','quotation.index','quotation.success','rolunk.index','szolgaltatasaink.index',
'toaster::hub','vendor.cookie-consent.button','vendor.cookie-consent.cookies','vendor.livewire.bootstrap','vendor.livewire.original-tailwind',
'vendor.livewire.simple-bootstrap','vendor.livewire.simple-tailwind','vendor.livewire.tailwind','vendor.toaster.hub','cookie-consent::button',
'cookie-consent::cookies','cookie-consent::info','filament-actions::badge-action','filament-actions::badge-group','filament-actions::button-action',
...
'filament::components.tabs.item','googletagmanager::body','googletagmanager::head','googletagmanager::script','laravel-exceptions-renderer::components.card',
...
'pagination::simple-default','pagination::simple-tailwind','pagination::tailwind','seo::tags.tag','sitemap::image',
'sitemap::news','sitemap::sitemap','sitemap::sitemapIndex.index','sitemap::sitemapIndex.sitemap','sitemap::url',
'sitemap::video','telescope::layout','toaster::hub',);
