...
'cookieconsent.url.domain','cookieconsent.url.middleware','cookieconsent.url.prefix','cookieconsent.cookie.name','cookieconsent.cookie.duration',
'cookieconsent.cookie.domain','cookieconsent.policy','cookieconsent.google_analytics.id','cookieconsent.google_analytics.anonymize_ip','debugbar.enabled',
...
'debugbar.options.mail.full_log','debugbar.options.views.timeline','debugbar.options.views.data','debugbar.options.views.group','debugbar.options.views.exclude_paths',
'debugbar.options.route.label','debugbar.options.session.hiddens','debugbar.options.symfony_request.hiddens','debugbar.options.logs.file','debugbar.options.cache.values',
'debugbar.inject','debugbar.route_prefix','debugbar.route_middleware','debugbar.route_domain','debugbar.theme',
'debugbar.debug_backtrace_limit','essentials.NunoMaduro\\Essentials\\Configurables\\Unguard','honeypot.enabled','honeypot.name_field_name','honeypot.randomize_name_field_name',
...
'honeypot.spam_protection','honeypot.with_csp','seo.model','seo.site_name','seo.sitemap',
...
'seo.twitter.@username','services.postmark.token','services.resend.key','services.ses.key','services.ses.secret',
...
'app.aliases.Uri','app.aliases.Validator','app.aliases.View','app.aliases.Vite','mail.default',
...
'mail.markdown.theme','mail.markdown.paths','database.default','database.connections.sqlite.driver','database.connections.sqlite.url',
...
'cache.prefix','concurrency.default','queue.default','queue.connections.sync.driver','queue.connections.database.driver',
...
'logging.channels.browser.days','logging.channels.deprecations.driver','logging.channels.deprecations.handler','filesystems.default','filesystems.disks.local.driver',
...
'filesystems.links./Users/szabozoltan/Herd/classen/public/storage','blade-heroicons.prefix','blade-heroicons.fallback','blade-heroicons.class','blade-heroicons.attributes',
...
'filament.livewire_loading_delay','filament.system_route_prefix','lang-generator.file_type','lang-generator.file_name','lang-generator.short_keys',
'lang-generator.languages','boost.enabled','boost.browser_logs_watcher','sanctum.stateful','sanctum.guard',
...
'helpers.laravel.guess_factory_names_with_support_namespace','ide-helper.filename','ide-helper.models_filename','ide-helper.meta_filename','ide-helper.include_fluent',
...
'signed','throttle','verified','ensure.quotation',);
...
'filament.admin.resources.doors.edit','filament.admin.resources.featured-sales-pages.index','filament.admin.resources.featured-sales-pages.create','filament.admin.resources.featured-sales-pages.view','filament.admin.resources.featured-sales-pages.edit',
'filament.admin.resources.meta-key-words.index','filament.admin.resources.meta-key-words.create','filament.admin.resources.meta-key-words.edit','filament.admin.resources.quotation-items.index','filament.admin.resources.quotation-items.create',
'filament.admin.resources.quotation-items.edit','filament.admin.resources.quotations.index','filament.admin.resources.quotations.create','filament.admin.resources.quotations.edit','filament.admin.resources.tags.index',
'filament.admin.resources.tags.create','filament.admin.resources.tags.edit','filament.admin.resources.users.index','filament.admin.resources.users.create','filament.admin.resources.users.edit',
'filament.admin.resources.website-options.index','filament.admin.resources.website-options.create','filament.admin.resources.website-options.view','filament.admin.resources.website-options.edit','boost.browser-logs',
...
'updateWebsiteDatabase.trigger','aszf','adatvedelem','featured-sales-areas.index','featured-sales-areas.show','ir-wenge-akcio','storage.local',);
        registerArgumentsSet('views', 
'auth.confirm-password','auth.forgot-password','auth.login','auth.register','auth.reset-password',
'auth.verify-email','blog.index','blog.show','collections.index','collections.show',
'collections.upload','components.auth-session-status','components.category.category-item','components.category.item-box','components.category.layout',
'components.category.partials.attribute','components.collections.item','components.collections.layout','components.collections.partials.additional-options','components.collections.partials.attribute',
'components.collections.partials.door-color-variant-selector','components.collections.partials.door-model-icons','components.collections.partials.door-model-selector','components.collections.partials.door-options','components.collections.partials.photos',
'components.collections.partials.prd-gallery','components.collections.partials.price','components.collections.partials.specifications','components.collections.partials.technical-parameters','components.danger-button',
'components.doors.partials.arrow-right','components.dropdown','components.dropdown-link','components.favorite.item','components.favorite.layout',
'components.favorite.partials.attribute','components.footer.layout','components.form','components.header.layout','components.hero-component',
'components.icons.facebook','components.icons.instagram','components.icons.mail','components.icons.pin','components.icons.youtube',
'components.input-error','components.input-label','components.layouts.app','components.layouts.navigation.navbar','components.modal',
'components.nav.breadcrumb','components.nav.breadcrumb-home-end','components.partials.blog','components.partials.collections-grid','components.partials.door-categories',
'components.partials.elonyok','components.partials.expert-help','components.partials.expert-help-index','components.partials.hero-banner','components.partials.hero-banner-2',
'components.partials.hero-banner-3','components.partials.prd-carousel','components.primary-button','components.responsive-nav-link','components.row',
'components.secondary-button','components.svg.application-logo','components.svg.arrow-left','components.svg.arrow-right','components.svg.boiler',
...
'doors.show','example','favorites.index','google.belteri','google.cpl',
'google.enterior','google.index','google.modern','google.raktari-ajtok-tokeletes-valasztas-otthonaba-es-munkahelyere','google.raktari-ajtok–megbizhatosag-tartossag',
...
'livewire.collection-item','livewire.door-options','livewire.featured-sales-areas-show','livewire.filter-for-category-sidebar','livewire.filter-for-product-sidebar',
...
'mail.form.contact-form','mail.quotation.inner-sended','mail.quotation.sended','pages.featured-sales-areas.index','pages.featured-sales-areas.show',
'pages.ir-wenge-belteri-ajto-akcio','profile.edit','profile.partials.delete-user-form','profile.partials.update-password-form','profile.partials.update-profile-information-form',
'quotation.index','quotation.success','rolunk.index','szolgaltatasaink.index','toaster::hub',
'vendor.cookie-consent.button','vendor.cookie-consent.cookies','vendor.livewire.bootstrap','vendor.livewire.original-tailwind','vendor.livewire.simple-bootstrap',
'vendor.livewire.simple-tailwind','vendor.livewire.tailwind','vendor.toaster.hub','cookie-consent::button','cookie-consent::cookies',
'cookie-consent::info','filament-actions::badge-action','filament-actions::badge-group','filament-actions::button-action','filament-actions::button-group',
...
'googletagmanager::body','googletagmanager::head','googletagmanager::script','honeypot::honeypotFormFields','laravel-exceptions-renderer::components.card',
...
'APP_LOCALE','APP_FALLBACK_LOCALE','APP_CHARSET','APP_LOCALES','APP_FAKER_LOCALE',
'APP_TIMEZONE','LOG_CHANNEL','LOG_DEPRECATIONS_CHANNEL','LOG_LEVEL','DB_CONNECTION',
'DB_HOST','DB_PORT','DB_DATABASE','DB_USERNAME','DB_PASSWORD',
'BROADCAST_DRIVER','CACHE_DRIVER','FILESYSTEM_DISK','QUEUE_CONNECTION','SESSION_DRIVER',
'SESSION_LIFETIME','SESSION_SECURE_COOKIE','MEMCACHED_HOST','REDIS_HOST','REDIS_PASSWORD',
...
'VITE_PUSHER_SCHEME','VITE_PUSHER_APP_CLUSTER','WORDPRESS_API_KEY','WORDPRESS_API_SECRET_KEY','GOOGLE_ANALYTICS_ID',
'GOOGLE_TAG_MANAGER_ID','TELESCOPE_ENABLED',);
