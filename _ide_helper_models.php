 ...
 * @property \Carbon\CarbonImmutable|null $created_at
 * @property \Carbon\CarbonImmutable|null $updated_at
 * @method static \Illuminate\Database\Eloquent\Builder<static>|FeaturedSalesPage newModelQuery()
 * @method static \Illuminate\Database\Eloquent\Builder<static>|FeaturedSalesPage newQuery()
 * @method static \Illuminate\Database\Eloquent\Builder<static>|FeaturedSalesPage query()
 * @method static \Illuminate\Database\Eloquent\Builder<static>|FeaturedSalesPage whereAuthor($value)
 * @method static \Illuminate\Database\Eloquent\Builder<static>|FeaturedSalesPage whereCategories($value)
 * @method static \Illuminate\Database\Eloquent\Builder<static>|FeaturedSalesPage whereCommentStatus($value)
 * @method static \Illuminate\Database\Eloquent\Builder<static>|FeaturedSalesPage whereContent($value)
 * @method static \Illuminate\Database\Eloquent\Builder<static>|FeaturedSalesPage whereCreatedAt($value)
 * @method static \Illuminate\Database\Eloquent\Builder<static>|FeaturedSalesPage whereDate($value)
 * @method static \Illuminate\Database\Eloquent\Builder<static>|FeaturedSalesPage whereDateGmt($value)
 * @method static \Illuminate\Database\Eloquent\Builder<static>|FeaturedSalesPage whereExcerpt($value)
 * @method static \Illuminate\Database\Eloquent\Builder<static>|FeaturedSalesPage whereFeaturedMedia($value)
 * @method static \Illuminate\Database\Eloquent\Builder<static>|FeaturedSalesPage whereFormat($value)
 * @method static \Illuminate\Database\Eloquent\Builder<static>|FeaturedSalesPage whereGuid($value)
 * @method static \Illuminate\Database\Eloquent\Builder<static>|FeaturedSalesPage whereId($value)
 * @method static \Illuminate\Database\Eloquent\Builder<static>|FeaturedSalesPage whereLink($value)
 * @method static \Illuminate\Database\Eloquent\Builder<static>|FeaturedSalesPage whereMeta($value)
 * @method static \Illuminate\Database\Eloquent\Builder<static>|FeaturedSalesPage whereModified($value)
 * @method static \Illuminate\Database\Eloquent\Builder<static>|FeaturedSalesPage whereModifiedGmt($value)
 * @method static \Illuminate\Database\Eloquent\Builder<static>|FeaturedSalesPage wherePingStatus($value)
 * @method static \Illuminate\Database\Eloquent\Builder<static>|FeaturedSalesPage whereSlug($value)
 * @method static \Illuminate\Database\Eloquent\Builder<static>|FeaturedSalesPage whereStatus($value)
 * @method static \Illuminate\Database\Eloquent\Builder<static>|FeaturedSalesPage whereSticky($value)
 * @method static \Illuminate\Database\Eloquent\Builder<static>|FeaturedSalesPage whereTags($value)
 * @method static \Illuminate\Database\Eloquent\Builder<static>|FeaturedSalesPage whereTemplate($value)
 * @method static \Illuminate\Database\Eloquent\Builder<static>|FeaturedSalesPage whereTitle($value)
 * @method static \Illuminate\Database\Eloquent\Builder<static>|FeaturedSalesPage whereType($value)
 * @method static \Illuminate\Database\Eloquent\Builder<static>|FeaturedSalesPage whereUpdatedAt($value)
 */
	final class FeaturedSalesPage extends \Eloquent {}
}
