            ...
            <div class="md:flex md:flex-col md:justify-between">
                ...
                <div class="grid grid-cols-3 gap-8 sm:grid-cols-1 sm:gap-6">
                    ...
                    <div>
                        ...
                        <ul class="font-medium text-gray-500">
                            <li class="mb-2">
                                <a class="hover:underline" href="mailto:hello@arcadia.hu">E-mail: hello@arcadia.hu</a>
                            </li>
                        ...
                        <ul class="font-medium text-gray-500">
                            <li class="mb-2">
                                <a class="hover:underline" href="#">ASZF</a>
                            </li>
                            <li class="mb-2">
                                <a class="hover:underline" href="#">Impresszum</a>
                            </li>
                            </li>
                        </ul>
                    </div>
                    <div>
                        ...
                        <div class="flex gap-2">
                            ...
                            <svg style="fill-rule:evenodd;clip-rule:evenodd;stroke-linejoin:round;stroke-miterlimit:2;"
                                ...
                                <path style="fill:rgb(15,15,15);fill-rule:nonzero;"
                            ...
                            <svg style="fill-rule:evenodd;clip-rule:evenodd;stroke-linejoin:round;stroke-miterlimit:2;"
                                ...
                                xml:space="preserve" xmlns:serif="http://www.serif.com/">
                                <path style="fill:rgb(15,15,15);fill-rule:nonzero;"
                                    d="M216.667,266.667C244.281,266.667 266.667,244.281 266.667,216.667C266.667,189.052 244.281,166.667 216.667,166.667C189.052,166.667 166.667,189.052 166.667,216.667C166.667,244.281 189.052,266.667 216.667,266.667Z" />
                                <path style="fill:rgb(15,15,15);fill-rule:nonzero;"
                                    d="M166.667,333.333C166.667,314.924 181.591,300 200,300L233.333,300C251.743,300 266.667,314.924 266.667,333.333L266.667,600C266.667,618.41 251.743,633.333 233.333,633.333L200,633.333C181.591,633.333 166.667,618.41 166.667,600L166.667,333.333Z" />
                                <path style="fill:rgb(15,15,15);fill-rule:nonzero;"
                                    d="M366.667,633.333L400,633.333C418.41,633.333 433.333,618.41 433.333,600L433.333,450C433.333,400 533.333,366.667 533.333,433.333L533.333,600.013C533.333,618.423 548.257,633.333 566.667,633.333L600,633.333C618.41,633.333 633.333,618.41 633.333,600L633.333,400C633.333,333.333 583.333,300 516.667,300C450,300 433.333,350 433.333,350L433.333,333.333C433.333,314.924 418.41,300 400,300L366.667,300C348.257,300 333.333,314.924 333.333,333.333L333.333,600C333.333,618.41 348.257,633.333 366.667,633.333Z" />
                                <path style="fill:rgb(15,15,15);"
                                    d="M666.667,33.333C721.897,33.333 766.667,78.105 766.667,133.333L766.667,666.667C766.667,721.897 721.897,766.667 666.667,766.667L133.333,766.667C78.105,766.667 33.333,721.897 33.333,666.667L33.333,133.333C33.333,78.105 78.105,33.333 133.333,33.333L666.667,33.333ZM666.667,100C685.077,100 700,114.924 700,133.333L700,666.667C700,685.077 685.077,700 666.667,700L133.333,700C114.924,700 100,685.077 100,666.667L100,133.333C100,114.924 114.924,100 133.333,100L666.667,100Z" />
                            </svg>
                            <svg style="fill-rule:evenodd;clip-rule:evenodd;stroke-linejoin:round;stroke-miterlimit:2;"
                                width="5%" height="5%" viewBox="0 0 800 800" version="1.1"
                                xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
