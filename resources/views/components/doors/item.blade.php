...
<div class="bg-white">
    <div class="pt-6">
                    ...
                    <div class="flex flex-wrap">
                        <div class="basis-1/3">
                            @foreach ($row['oszlop_1'] ?? [] as $col)
                                <div class="flex flex-wrap border-1 border-gray-400">
                                    <h2 class="basis-full"><b>{{ __($col['cim']) }}</b></h2>
                        ...
                        <div class="basis-1/3">
                            @foreach ($row['oszlop_2'] ?? [] as $col)
                                <div class="flex flex-wrap border-1 border-gray-400">
                                    <h3 class="basis-full">{{ __($col['cim']) }}</h3>
                                    @foreach ($col['almezo_tartalom'] ?? [] as $subrow)
                                        <div class="basis-full">
                                            {{ __($subrow['tartalom']) }}
                                        </div>
        ...
        <div class="mt-9 flex w-full flex-row flex-wrap">
            @foreach ($category->technical_parameter ?? [] as $row)
                <div class="basis-full">
                    <div class="flex flex-wrap">
                        <div class="basis-1/3">
                            @foreach ($row['oszlop_1'] ?? [] as $col)
        ...
        <div class="mt-9 flex w-full flex-row flex-wrap">
            @foreach ($category->additional_options ?? [] as $row)
                <div class="basis-full">
                    <div class="flex flex-wrap">
                        <div class="basis-1/3">
                            @foreach ($row['oszlop_1'] ?? [] as $col)
