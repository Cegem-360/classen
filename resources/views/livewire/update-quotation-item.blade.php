<div>
    ...
    <div class="max-w-32 relative flex flex-wrap items-center">
        ...
        <div class="flex w-full flex-wrap">
            <div class="w-full">
                <input class="form-radio w-[10%]" id="{{ Str::slug(__('Adjustable door frame')) }}" type="radio"
                    value="{{ __('Adjustable door frame') }}" wire:model.live="frame" @selected($frame == __('Adjustable door frame'))>
                <span class="ml-2 w-[90%]">{{ __('Adjustable door frame') }}</span>
            </div>
            <div class="w-full">
                <input class="form-radio w-[10%]" id="{{ Str::slug(__('Adjustable non-rebated door frame')) }}"
                ...
                <span class="ml-2 w-[90%]">{{ __('Adjustable non-rebated door frame') }}</span>
            </div>
            <div class="w-full">
                <input class="form-radio w-[10%]" id="{{ Str::slug(__('Standard 2-Pack door frame')) }}" type="radio"
                    value="{{ __('Standard 2-Pack door frame') }}" wire:model.live="frame" @selected($frame == __('Standard 2-Pack door frame'))>
                <span class="ml-2 w-[90%]">{{ __('Standard 2-Pack door frame') }}</span>
            </div>
        </div>
    </div>
